About cuda-cuobjdump-feedstock
==============================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/cuda-cuobjdump-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cuda-cuobjdump-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `cuda-cuobjdump` available on your platform:
...
```
pixi search cuda-cuobjdump --channel conda-forge
```
